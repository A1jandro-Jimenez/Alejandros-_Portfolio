...
<div align="center">
<img src="Portfolio Pics/ELT_Pipeline.png" width="600">
</div>
...
## Project Goals
When creating the project, I had the following goals in mind that I wanted to achievee:
...
With these findings, not only artists, but also record labels and others in the music industry can use the information to increase their chances
of having hit singles or sign the next big artist all from analyzing the most successful songs of the past few years. 
